...
struct StatusView2: View {
    var body: some View {
        ...
        let leftShoulder=CGPoint(x: w*0.63, y: h*0.25)
        let rightShoulder=CGPoint(x: w*0.37, y: h*0.25)
        let leftElbow=CGPoint(x: w*0.63, y: h*0.40)
        let rightElbow=CGPoint(x: w*0.37, y: h*0.40)
        let leftWrist=CGPoint(x: w*0.63, y: h*0.55)
        let rightWrist=CGPoint(x: w*0.37, y: h*0.55)
        let leftHip=CGPoint(x: w*0.6, y: h*0.5)
        let rightHip=CGPoint(x: w*0.4, y: h*0.5)
        let leftKnee=CGPoint(x: w*0.6, y: h*0.65)
        let rightKnee=CGPoint(x: w*0.4, y: h*0.65)
        let leftAnkle=CGPoint(x: w*0.6, y: h*0.8)
        let rightAnkle=CGPoint(x: w*0.4, y: h*0.8)
        ...
        ZStack{
            ...
            Path { path in
                path.addArc(center: rightWrist, radius: ps, startAngle: .degrees(0), endAngle: .degrees(360), clockwise: true)
                path.addArc(center: rightElbow, radius: ps, startAngle: .degrees(0), endAngle: .degrees(360), clockwise: true)
                path.addArc(center: rightShoulder, radius: ps, startAngle: .degrees(0), endAngle: .degrees(360), clockwise: true)
                path.addArc(center: leftShoulder, radius: ps, startAngle: .degrees(0), endAngle: .degrees(360), clockwise: true)
                path.addArc(center: leftElbow, radius: ps, startAngle: .degrees(0), endAngle: .degrees(360), clockwise: true)
                path.addArc(center: leftWrist, radius: ps, startAngle: .degrees(0), endAngle: .degrees(360), clockwise: true)
                
                path.addArc(center: rightAnkle, radius: ps, startAngle: .degrees(0), endAngle: .degrees(360), clockwise: true)
                path.addArc(center: rightKnee, radius: ps, startAngle: .degrees(0), endAngle: .degrees(360), clockwise: true)
                path.addArc(center: rightHip, radius: ps, startAngle: .degrees(0), endAngle: .degrees(360), clockwise: true)
                path.addArc(center: leftHip, radius: ps, startAngle: .degrees(0), endAngle: .degrees(360), clockwise: true)
                path.addArc(center: leftKnee, radius: ps, startAngle: .degrees(0), endAngle: .degrees(360), clockwise: true)
                path.addArc(center: leftAnkle, radius: ps, startAngle: .degrees(0), endAngle: .degrees(360), clockwise: true)
            }
            .fill(Color.yellow)
            .frame(width: bounds.width, height: bounds.height)
